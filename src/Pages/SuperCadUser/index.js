...
export default function CadUser() {
    ...
    const { signUpSuper, loadingAuth } = useContext(AuthContext);


    function handleSubmit(e) {
        e.preventDefault();
        if (nome !== '' && status === 'superuser' && email !== '' && senha !== '') {
            signUpSuper(email, senha, nome, status);
            setNome('');
            setStatus('');
            setSenha('');
            setEmail('');
            ...
            <div className='displayCadastro'>
                <div className='cadastro'>
                    ...
                    <form className='formCadastro' onSubmit={handleSubmit}>
                        ...
                        <label>Status :</label>
                        <input type='text' placeholder='Digite aqui seu sobrenome' value={status} onChange={(e) => setStatus(e.target.value)} required /><br /><br />
                        <label>Email :</label>
